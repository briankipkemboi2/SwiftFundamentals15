...
print("The code does not compile because friends are declared as friends with let and constants cannot be changed after they are declared
/*:
 ...
 */
age = 29
      print("After my birthday, my age is now \(age) ")
/*:
 ...
 */
      // but double is a primitive type, i think thats why its not compiling
var double = 1.1
 print(double)
 double = 2.2
 print(double)
